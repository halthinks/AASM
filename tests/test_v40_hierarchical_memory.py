...
def test_v40_contract_and_public_api():
    assert __version__=='0.40.0'; assert hierarchical_memory_contract()['contract_id']=='aasm.memory.hierarchical.v1'; report=validate_public_api_contract(); assert report['valid'],report; assert report['contract']['contract_version']=='0.16.0'
