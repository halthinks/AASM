...
def test_trace_contract_and_version_are_public():
    assert __version__=="0.53.0"; assert trace_contract()["contract_id"]=="aasm.trace.v1"; assert provenance_contract()["contract_id"]=="aasm.provenance.v1"; assert semantic_problem_contract()["contract_id"]=="aasm.semantic.problem.v1"; assert semantic_compiler_contract()["contract_id"]==SEMANTIC_COMPILER_CONTRACT_ID; assert validate_public_api_contract()["valid"] is True
