...
def main():
    ...
    if version!='0.41.0': raise SystemExit(f'unexpected formal release version: {version}')
    ...
    require(root/'src/aasm/reuse_validation.py',['non_idempotent_effect_never_reused','subsumption_validator_required'])
    print('v0.41 formal contracts: PASS'); return 0
