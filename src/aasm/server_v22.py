...
# server_v19 resolves its module-global engine for each request. Updating the
# binding preserves the established HTTP surface while exposing v0.22 state in
# dashboards and all inherited runtime operations.
...
def make_handler(store_target: str, token: str | None = None, provisioners=None, artifacts=None):
    ...
    handler.server_version = "AASM/0.22"
    return handler
