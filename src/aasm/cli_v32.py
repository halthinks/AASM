...
def _provenance_export(args):
    _v31._with_engine(args, lambda engine: _v31._json(engine.provenance_export(args.output, key=_key(args.key_file), signer_id=args.signer_id)))
